    ...
    <div class="container px-4 mx-auto xl:px-0">
        <div class="grid gap-12 xl:grid-cols-6 xl:gap-24">
            <div class="col-span-2">
                ...
                <p class="max-w-lg mt-4 text-gray-500 dark:text-gray-400">Stockify adalah aplikasi web yang dirancang untuk membantu bisnis, khususnya yang memiliki gudang, dalam mengelola stok barang secara efisien dan akurat.
.</p>
            </div>
            <div>
                ...
                <ul>
                    <li class="mb-4">
                        <a href="https://flowbite.com" target="_blank" rel="noreferrer" class="font-normal text-gray-600 hover:underline dark:text-gray-400">Stockify</a>
                    </li>
                    <li class="mb-4">
        ...
        <span class="block text-center text-gray-600 dark:text-gray-400">© 2019-<span id="currentYear">2023</span> <a href="https://flowbite.com" target="_blank" rel="noreferrer">Stockify</a>. All Rights Reserved.
        </span>
    </div>
</footer>