        ...
        <div id="carousel" class="relative" data-carousel="">
          <div class="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
              <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800" data-carousel-item>
                ...
                <p class="mb-4 text-gray-500 dark:text-gray-400">Stockify adalah aplikasi web yang dirancang untuk membantu bisnis, khususnya yang memiliki gudang, dalam mengelola stok barang secara efisien dan akurat</p>
