    ...
    <div>
        ...
        <table class="min-w-full bg-white dark:bg-gray-800 rounded-lg shadow text-center align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td class="py-2 px-4 border-b text-gray-700 dark:text-gray-300 text-center align-middle">{{ $activity->user->name ?? 'N/A' }}</td>
                    <td class="py-2 px-4 border-b text-gray-700 dark:text-gray-300 text-center align-middle">{{ $activity->product->name ?? 'N/A' }}</td>
