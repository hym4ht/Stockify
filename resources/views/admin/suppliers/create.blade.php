...
<div class="container mx-auto px-4 py-6 max-w-lg">
    <h1 class="text-2xl font-semibold mb-4">Add New Supplier</h1>
    ...
    <form action="{{ route('admin.suppliers.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="contact_name" id="contact_name" value="{{ old('contact_name') }}" class="w-full border border-gray-300 rounded px-3 py-2">
        </div>
        ...
        <div>
            ...
            <textarea name="address" id="address" rows="3" class="w-full border border-gray-300 rounded px-3 py-2">{{ old('address') }}</textarea>
        </div>
