...
@section('content')
<div class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 dark:bg-opacity-80">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-lg mx-4">
        <h1 class="text-2xl font-semibold mb-4 text-black dark:text-white">Add New User</h1>
