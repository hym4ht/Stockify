...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('admin.stock.store') }}" method="POST" class="max-w-lg">
        @csrf
        ...
        <button type="submit" class="bg-blue-600 text-white font-bold py-2 px-4 rounded mb-4 inline-block hover:bg-blue-800 focus:bg-blue-800 transition duration-300 ease-in-out bg-opacity-100">Add Transaction</button>
