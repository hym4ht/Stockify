    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
          ...
          <div id="toggleSidebarMobileHamburger" class="relative w-8 h-8 overflow-visible">
            <img src="{{ asset('static/images/logo.svg') }}" alt="Menu Icon"
              class="absolute -top-2 -left-2 w-12 h-12" />
          </div>
        ...
        <span class="self-center text-xl font-semibold xss:text-2xl whitespace-nowrap dark:text-white">Stockify</span>
      </div>
      <div class="flex items-center">
        <div
          class="z-50 hidden my-4 w-full max-w-m-d text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
