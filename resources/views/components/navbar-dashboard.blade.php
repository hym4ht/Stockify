...
<a href="{{ route('chat.inbox') }}" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
  <svg class="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex items-center ml-3">
          <div>
            <div class="flex text-sm bg-gray-800 rounded-full">
              ...
              @endphp
              <img class="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo" title="{{ $name }}">
            </div>
          </div>
          <div class="ml-2 text-white font-semibold">
            {{ $name }}
          </div>
        </div>
      </div>
