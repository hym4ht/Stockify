...
class ReportController extends Controller
{
    ...
    public function managerStockReport(Request $request)
    {
        $query = Product::query();
        ...
        return view('manager.reports.stock', compact('products', 'stockSums', 'categories', 'attributeNames', 'attributeValues'));
    }
